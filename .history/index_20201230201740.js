    ...
    buttons.forEach((button) => {
        button.addEventListener("click", function (event)  {
            if(event.target.parentElement.classList.contains("rightBtn") || event.target.classList.contains("rightBtn")) {
                ...
                let commentList = comments.map(comment => ( `
                <div class="comment-card" id=${comment[newIndex].index}>
                    <div class="comment-card-header">
                        <div class="comment-header-display">
                            <div class="comment-profile-image-container">
                                <div class="comment-image-container">
                                    <img class="comment-img" src=${comment[newIndex].img} alt="">
                                </div>
                            </div>
                            <div class="comment-profile-detail">
                                <p>${comment[newIndex].name}</p>
                                <div class="comment-center">
            
                                </div>
                                <p>${comment[newIndex].job}</p>
                            </div>
                        </div>
            
                        <div class="comment-number">
                            <p>${comment[newIndex].index}</p>
                        </div>
                    </div>
            
                    
                    <div class="comment-details">
                        <p>${comment[newIndex].comment}.</p>
                    </div>
                </div>
